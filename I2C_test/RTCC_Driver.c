...
void ReadRTCCAlarm0(RTCCAlarm* ptrToUserVal)
{
	...
	ptrToUserVal-> DummyVal = READ_I2C(CNTRL_BYTE_SRAM_RTCC,RTCC_ALARM0_DAY_REG) ;
...
void WriteRTCCAlarm0(RTCCAlarm* ptrToUserVal)
{
	...
	WRITE_I2C(CNTRL_BYTE_SRAM_RTCC,RTCC_ALARM0_DAY_REG,ptrToUserVal-> DummyVal);
...
void ReadRTCCAlarm1(RTCCAlarm* ptrToUserVal)
{
	...
	ptrToUserVal-> DummyVal = READ_I2C(CNTRL_BYTE_SRAM_RTCC,RTCC_ALARM1_DAY_REG) ;
...
void WriteRTCCAlarm1(RTCCAlarm* ptrToUserVal)
{
	...
	WRITE_I2C(CNTRL_BYTE_SRAM_RTCC,RTCC_ALARM1_DAY_REG,ptrToUserVal-> DummyVal);
...
void ReadRTCCTimeStamp_VCC_Restore(RTCCTimeStampVcc* ptrToUserVal)
{
	...
	ptrToUserVal-> Day_Month = READ_I2C(CNTRL_BYTE_SRAM_RTCC,RTCC_VCC_RESTORE_DAY_MONTH_REG);
}
